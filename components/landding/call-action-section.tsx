...
export function CallActionSection() {
  return (
    <>
      <section className="flex-col from-background to-muted/50 flex w-full items-center justify-center border-x border-b bg-gradient-to-b px-2 py-12 md:px-0 md:py-16 lg:py-20">
