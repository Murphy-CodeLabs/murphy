...
function SearchAIInput(props: FormHTMLAttributes<HTMLFormElement>) {
  ...
  return (
    <form
      {...props}
      className={cn(
        "flex flex-row items-start rounded-xl border pe-2 bg-popover text-fd-popover-foreground transition-colors shadow-lg",
...
function Content() {
  ...
  return (
    <ChatContext value={chat}>
      ...
      <div className="flex flex-row gap-2 items-center bg-muted text-fd-muted-foreground px-3 py-1.5 rounded-b-xl border-b border-x shadow-lg">
