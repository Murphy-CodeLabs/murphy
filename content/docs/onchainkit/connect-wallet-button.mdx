...
<TypeTable
  type={{
    ...
    labels: {
      description: "Custom labels for button states",
...
The Connect Wallet Button now supports LazorKit Passkey wallet connections. When clicked, it opens a modal with two tabs:
