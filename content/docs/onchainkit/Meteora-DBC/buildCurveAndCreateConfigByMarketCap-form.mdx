...
<PreviewComponent name={"Build Curve And Create Config By Market Cap Form"} v0JsonFileName={"buildCurveAndCreateConfigByMarketCap-form"}>
...
export default function MyPage() {
  return (
    <div>
      <h1 className="text-xl font-bold mb-2">Tạo cấu hình theo vốn hóa thị trường</h1>
      <BuildCurveAndCreateConfigByMarketCapForm />
    </div>
  );
}
...
export default function MyPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold mb-2">Create Configuration by Market Cap</h1>
      <BuildCurveAndCreateConfigByMarketCapForm 
