...
import TxnExplorerLinkPreiew from "@/components/txn-explorer-link-preview";
...
import { TxnExplorerLink } from "@/components/ui/murphy/tx-explorer-link";
