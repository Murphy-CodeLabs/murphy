...
<PreviewComponent name="Step Flow Dialog Preview" v0JsonFileName="step-flow-dialog-preview">
...
export default function StepFlowDemo() {
  ...
  const steps = [
    { id: "1", title: "Step One", description: "Do something", status: "pending" },
    { id: "2", title: "Step Two", description: "Do next thing", status: "pending" },
    { id: "3", title: "Step Three", description: "Finish it", status: "pending" },
  ]
